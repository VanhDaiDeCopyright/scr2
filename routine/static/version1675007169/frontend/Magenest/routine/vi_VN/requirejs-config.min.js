...
require.config(config);})();(function(){var config={config:{mixins:{'Magento_Ui/js/lib/validation/validator':{'Magento_Checkout/js/validator/telephone-with-prefix':true}}}}
require.config(config);})();(function(){var config={config:{mixins:{'mage/validation':{'Magento_Review/js/validation-mixin':true}}}}
require.config(config);})();(function(){var config={config:{mixins:{'mage/validation':{'Magenest_Directory/js/validation-mixin':true}}}}
require.config(config);})();(function(){var config={paths:{"slickCarousel":'js/slick',},shim:{'slickCarousel':{'deps':['jquery']}}};require.config(config);})();})(require);